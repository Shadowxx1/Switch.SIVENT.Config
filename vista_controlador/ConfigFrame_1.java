...
import com.jswitch.base.modelo.entidades.Departamento;
 ...
 * @author bc
 */
public class ConfigFrame_1 extends JFrame {
    ...
    private void initComponents() {
        ...
        gridControlOficinas = new org.openswing.swing.client.GridControl();
        ...
        gridControlDepartamentos = new org.openswing.swing.client.GridControl();
        ...
        gridControlOficinas.setDeleteButton(deleteButton6);
        gridControlOficinas.setEditButton(editButton6);
        gridControlOficinas.setInsertButton(insertButton6);
        gridControlOficinas.setMaxNumberOfRowsOnInsert(4);
        gridControlOficinas.setReloadButton(reloadButton6);
        gridControlOficinas.setSaveButton(saveButton6);
        gridControlOficinas.setValueObjectClassName(Oficina.class.getName());
        gridControlOficinas.setVisibleStatusPanel(false);
        ...
        gridControlOficinas.getColumnContainer().add(decimalColumn4);

        textColumn17.setColumnName("codigo");
        textColumn17.setColumnSortable(true);
        textColumn17.setEditableOnEdit(true);
        textColumn17.setEditableOnInsert(true);
        gridControlOficinas.getColumnContainer().add(textColumn17);

        textColumn18.setColumnName("nombre");
        textColumn18.setColumnSortable(true);
        textColumn18.setEditableOnEdit(true);
        textColumn18.setEditableOnInsert(true);
        gridControlOficinas.getColumnContainer().add(textColumn18);

        textColumn19.setColumnName("direccion");
        textColumn19.setColumnSortable(true);
        textColumn19.setEditableOnEdit(true);
        textColumn19.setEditableOnInsert(true);
        gridControlOficinas.getColumnContainer().add(textColumn19);

        textColumn20.setColumnName("telefono");
        textColumn20.setColumnSortable(true);
        textColumn20.setEditableOnEdit(true);
        textColumn20.setEditableOnInsert(true);
        gridControlOficinas.getColumnContainer().add(textColumn20);

        textColumn21.setColumnName("responsable");
        textColumn21.setColumnSortable(true);
        textColumn21.setEditableOnEdit(true);
        textColumn21.setEditableOnInsert(true);
        gridControlOficinas.getColumnContainer().add(textColumn21);

        textColumn22.setColumnName("emailOficinaSoporte");
        textColumn22.setColumnSortable(true);
        textColumn22.setEditableOnEdit(true);
        textColumn22.setEditableOnInsert(true);
        gridControlOficinas.getColumnContainer().add(textColumn22);

        textColumn23.setColumnName("emailSistemaSoporte");
        textColumn23.setColumnSortable(true);
        textColumn23.setEditableOnEdit(true);
        textColumn23.setEditableOnInsert(true);
        gridControlOficinas.getColumnContainer().add(textColumn23);

        jPanel38.setLayout(new java.awt.GridLayout(3, 2, 2, 2));
        jPanel38.add(insertButton6);
        jPanel38.add(editButton6);
        jPanel38.add(deleteButton6);
        jPanel38.add(saveButton6);
        jPanel38.add(reloadButton6);
        ...
        jPanel37Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel37Layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(gridControlOficinas, javax.swing.GroupLayout.DEFAULT_SIZE, 934, Short.MAX_VALUE))
        );
        jPanel37Layout.setVerticalGroup(
            jPanel37Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(jPanel38, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
            .addComponent(gridControlOficinas, javax.swing.GroupLayout.DEFAULT_SIZE, 187, Short.MAX_VALUE)
        );
        ...
        jTabbedPane3.addTab("Oficinas", jPanel10);

        jPanel35.setBorder(javax.swing.BorderFactory.createTitledBorder(""));

        gridControlDepartamentos.setDeleteButton(deleteButton5);
        gridControlDepartamentos.setEditButton(editButton5);
        gridControlDepartamentos.setInsertButton(insertButton5);
        gridControlDepartamentos.setMaxNumberOfRowsOnInsert(4);
        gridControlDepartamentos.setReloadButton(reloadButton5);
        gridControlDepartamentos.setSaveButton(saveButton5);
        gridControlDepartamentos.setValueObjectClassName(Departamento.class.getName());
        gridControlDepartamentos.setVisibleStatusPanel(false);

        decimalColumn3.setColumnName("id");
        decimalColumn3.setColumnRequired(false);
        decimalColumn3.setColumnSortable(true);
        decimalColumn3.setPreferredWidth(40);
        gridControlDepartamentos.getColumnContainer().add(decimalColumn3);

        textColumn15.setColumnName("codigo");
        textColumn15.setColumnSortable(true);
        textColumn15.setEditableOnEdit(true);
        textColumn15.setEditableOnInsert(true);
        gridControlDepartamentos.getColumnContainer().add(textColumn15);

        textColumn16.setColumnName("nombre");
        textColumn16.setColumnSortable(true);
        textColumn16.setEditableOnEdit(true);
        textColumn16.setEditableOnInsert(true);
        gridControlDepartamentos.getColumnContainer().add(textColumn16);

        textColumn24.setColumnName("direccion");
        textColumn24.setColumnSortable(true);
        textColumn24.setEditableOnEdit(true);
        textColumn24.setEditableOnInsert(true);
        gridControlDepartamentos.getColumnContainer().add(textColumn24);

        textColumn25.setColumnName("telefono");
        textColumn25.setColumnSortable(true);
        textColumn25.setEditableOnEdit(true);
        textColumn25.setEditableOnInsert(true);
        gridControlDepartamentos.getColumnContainer().add(textColumn25);

        textColumn26.setColumnName("responsable");
        textColumn26.setColumnSortable(true);
        textColumn26.setEditableOnEdit(true);
        textColumn26.setEditableOnInsert(true);
        gridControlDepartamentos.getColumnContainer().add(textColumn26);

        textColumn27.setColumnName("emailOficinaSoporte");
        textColumn27.setColumnSortable(true);
        textColumn27.setEditableOnEdit(true);
        textColumn27.setEditableOnInsert(true);
        gridControlDepartamentos.getColumnContainer().add(textColumn27);

        textColumn28.setColumnName("emailSistemaSoporte");
        textColumn28.setColumnSortable(true);
        textColumn28.setEditableOnEdit(true);
        textColumn28.setEditableOnInsert(true);
        gridControlDepartamentos.getColumnContainer().add(textColumn28);

        jPanel36.setLayout(new java.awt.GridLayout(3, 2, 2, 2));
        jPanel36.add(insertButton5);
        jPanel36.add(editButton5);
        jPanel36.add(deleteButton5);
        jPanel36.add(saveButton5);
        jPanel36.add(reloadButton5);
        ...
        jPanel35Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel35Layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(gridControlDepartamentos, javax.swing.GroupLayout.DEFAULT_SIZE, 934, Short.MAX_VALUE))
        );
        jPanel35Layout.setVerticalGroup(
            jPanel35Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(jPanel36, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
            .addComponent(gridControlDepartamentos, javax.swing.GroupLayout.DEFAULT_SIZE, 187, Short.MAX_VALUE)
        );
        ...
        jTabbedPane3.addTab("Departamentos", jPanel34);
        ...
        jPanel11Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel11Layout.createSequentialGroup()
                ...
                .addGroup(jPanel11Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(jTabbedPane3, javax.swing.GroupLayout.DEFAULT_SIZE, 1064, Short.MAX_VALUE))
                .addContainerGap())
        );
        ...
        jButton4.setText("Crear Base de Datos");
...
//            s.save(getEncabezadoReporte(empresa));
    ...
    private org.openswing.swing.client.GridControl gridControlDepartamentos;
    private org.openswing.swing.client.GridControl gridControlOficinas;
